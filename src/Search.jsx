...
const Search = ({ tableId }) => {
  const [items, setItems] = useState([
    ...
    { id: 79, text: "Piiza Hawaii", price: 10.90, percent: 7 },
    { id: 80, text: "Pizza Margherita", price: 8.90, percent: 7 },
    { id: 81, text: "Pizza della Casa", price: 13.50, percent: 7 },
    { id: 82, text: "Pizza Prosciutto", price: 9.40, percent: 7 },
    { id: 83, text: "Pizza Don Padrino", price: 13.50, percent: 7 },
    { id: 84, text: "Pizza Bianca", price: 10.90, percent: 7 },
    { id: 85, text: "Pizza Funghi", price: 9.40, percent: 7 },
    { id: 86, text: "Pizza Salami", price: 9.40, percent: 7 },
    { id: 87, text: "Pizza Sardele", price: 0, percent: 7 },
    { id: 88, text: "Pizza Tonno", price: 10.60, percent: 7 },
    { id: 89, text: "Pizza Pesto", price: 9.40, percent: 7 },
    { id: 90, text: "Pizza Capricciosa", price: 10.70, percent: 7 },
    { id: 91, text: "Pizza Gorgonzola e Spinace", price: 10.50, percent: 7 },
    { id: 93, text: "Pizza Siciliana", price: 11.20, percent: 7 },
    { id: 94, text: "Pizza Frutti di Mare", price: 13.90, percent: 7 },
    { id: 96, text: "Pizza Quattro Stagioni", price: 10.90, percent: 7 },
    { id: 97, text: "Pizza Vegetariana", price: 11.20, percent: 7 },
    { id: 98, text: "Pizza Diavolo", price: 0, percent: 7 },
    { id: 99, text: "Pizza Calzone", price: 11.30, percent: 7 },
