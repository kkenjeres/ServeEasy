...
const Search = ({ tableId }) => {
  ...
  { id: 3, text: "Sherry", price: 4.20, percent: 19},
    ...
    { id: 53, text: "Torellini Al Forno", price: 10.90, percent: 7, category:'pizza' },
    ...
    { id: 60, text: "Tris di Pasta Ripieno, al Burro e Salvia", price: 11.90, percent: 7, category:'pizza' },
    { id: 62, text: "Tagliatelle al pesto", price: 12.40, percent: 7, category:'pizza' },
    { id: 63, text: "Tonno mit Zwibel", price: 11.10, percent: 7, category:'pizza' },
    ...
    { id: 198, text: "Saftchorle 0.3", price: 3.30, percent: 19, options: ["Orange", "Maracuja", "Apfel", "Johannes"]},
    { id: 199, text: "Saftchorle 0.4", price: 4.10, percent: 19 , options: ["Orange", "Maracuja", "Apfel", "Johannes"]},
